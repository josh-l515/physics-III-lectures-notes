...
\end{tikzpicture}
 ...
 \begin{multicols}{2}
    ...
    \end{excercise}
    \input{sections/std/luz.tex}
    \input{sections/std/graciela.tex}
    \input{sections/std/noel.tex}
    \input{sections/std/max.tex}
    \input{sections/std/rulo.tex}
    \input{sections/std/Anais.tex}
